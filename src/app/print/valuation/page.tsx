  ...
  return (
    <div style={{ padding: '40px', backgroundColor: 'white', color: 'black', minHeight: '100vh' }}>
          ...
          {venuePrograms.map((program, pIndex) => (
            ...
            >
              ...
              <div style={{ padding: '0 15px' }}>
                <div style={{ borderBottom: '2px solid #ccc', paddingBottom: '10px', marginBottom: '15px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                  <div>
                  ...
                  <div style={{ display: 'flex', gap: '30px', alignItems: 'flex-end' }}>
                    ...
                    <div style={{ textAlign: 'center', marginLeft: '20px' }}>
                      <div style={{ borderBottom: '1px solid #000', width: '200px', height: '25px', marginBottom: '5px' }}></div>
                      <div style={{ fontSize: '0.9rem', fontWeight: 'bold' }}>Name & Signature of Judge</div>
                    </div>
                  </div>
                </div>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead>
                      <tr style={{ backgroundColor: '#f9f9f9', textAlign: 'center' }}>
                        <th style={{ border: '1px solid #000', padding: '10px', width: '50px' }}>Slot</th>
                        <th style={{ border: '1px solid #000', padding: '10px', width: '80px' }}>Code Letter</th>
                        <th style={{ border: '1px solid #000', padding: '10px', width: '120px' }}>Criteria 1<br/><span style={{fontSize: '0.8rem', fontWeight: 'normal'}}>(      ) Marks</span></th>
                        <th style={{ border: '1px solid #000', padding: '10px', width: '120px' }}>Criteria 2<br/><span style={{fontSize: '0.8rem', fontWeight: 'normal'}}>(      ) Marks</span></th>
                        <th style={{ border: '1px solid #000', padding: '10px', width: '120px' }}>Criteria 3<br/><span style={{fontSize: '0.8rem', fontWeight: 'normal'}}>(      ) Marks</span></th>
                        <th style={{ border: '1px solid #000', padding: '10px', width: '100px' }}>Total Marks</th>
                        <th style={{ border: '1px solid #000', padding: '10px', textAlign: 'left' }}>Remarks / Comments</th>
                      </tr>
                    </thead>
                    <tbody>
                      {program.assignments.map((assignment: any, index: number) => (
                        <tr key={assignment.id}>
                          <td style={{ border: '1px solid #000', padding: '15px 10px', fontWeight: 'bold', textAlign: 'center', fontSize: '1.2rem' }}>
                            {assignment.slotNumber || index + 1}
                          </td>
                          <td style={{ border: '1px solid #000', padding: '15px 10px' }}></td>
                          <td style={{ border: '1px solid #000', padding: '15px 10px' }}></td>
                          <td style={{ border: '1px solid #000', padding: '15px 10px' }}></td>
                          <td style={{ border: '1px solid #000', padding: '15px 10px' }}></td>
                          <td style={{ border: '1px solid #000', padding: '15px 10px' }}></td>
      ...
      <div className="no-print" style={{ position: 'fixed', bottom: '20px', right: '20px' }}>
        <PrintButton label="Print Valuation Sheets" />
      </div>
    </div>
  );
}
